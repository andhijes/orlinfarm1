...
<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    ...
    <div class="x_content">
      ...
      <form class="" action="{{ route('akun.pemasukanStore')}}" method="post">
        {{ csrf_field() }}
            ...
            @foreach($row as $cabang_akun)
              <tr>
                ...
                <td>
                  ...
                  <a href="{{ route('pemasukan.delete',$cabang_akun->id_cabang)}}"  class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
