        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span><?php echo $__env->yieldContent('name'); ?></span></a>
            </div>
            ...
            <div class="profile clearfix">
              ...
              <div class="profile_info">
                <span>Welcome,</span>
                <h2><?php echo $__env->yieldContent('name'); ?></h2>
              </div>
            </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/img.jpg" alt=""><?php echo $__env->yieldContent('name'); ?>
...
<?php echo $__env->make('layouts.headlink', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>