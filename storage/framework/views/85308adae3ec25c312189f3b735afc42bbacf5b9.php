...
<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    ...
    <div class="x_content">
      ...
      <form class="" action="<?php echo e(route('akun.hutangStore')); ?>" method="post">
    ...
    <div class="x_panel">
      ...
      <div class="x_content">
        <table id="datatable-buttons" class="table table-striped table-bordered">
          ...
          <tbody>
            <?php $counter=1; ?>
            <?php $__currentLoopData = $row_hutang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cabang_akun): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
