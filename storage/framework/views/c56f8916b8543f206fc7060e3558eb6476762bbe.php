    ...
    <div class="x_content">
      ...
      <form class="" action="<?php echo e(route('akun.modalStore')); ?>" method="post">
        ...
        <div class="form-group<?php echo e($errors->has('kode') ? ' has-error' : ''); ?>">
           ...
           <input id="nama" type="number" class="form-control" name="kode" placeholder="Kode Modal.." value="<?php echo e(old('kode')); ?>">
         ...
         <div class="form-group<?php echo e($errors->has('nama') ? ' has-error' : ''); ?>">
            ...
            <input id="harga"type="string" class="form-control" name="nama" placeholder="Nama Modal.." value="<?php echo e(old('nama')); ?>">
